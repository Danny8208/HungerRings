...
public class InfusionPedestalRenderer extends TileEntityRenderer<InfusionPedestalTile> {
    public InfusionPedestalRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn);
    }

    @Override
    public void render(InfusionPedestalTile pedestal, float partialTicks, MatrixStack matrix, IRenderTypeBuffer buffer, int i, int i1) {
