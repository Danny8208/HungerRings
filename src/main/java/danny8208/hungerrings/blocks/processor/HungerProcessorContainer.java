...
public class HungerProcessorContainer extends Container {
    ...
    public HungerProcessorContainer(int id, PlayerInventory inventory, PlayerEntity player, World world, BlockPos pos) {
        super(ModRegistries.HUNGER_PROCESSOR_CONTAINER.get(), id);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity, ModRegistries.HUNGER_PROCESSOR.get());
    }
